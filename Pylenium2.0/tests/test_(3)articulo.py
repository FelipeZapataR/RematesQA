...
def test_crear_articulo(page:Sele):
    ...
    page.Send('//*[@id="crear-articulo-form"]/div[6]/div/div[1]/input','C:/Users/felep/OneDrive/Documentos/VSCode/Pylenium 2.0/Pylenium2.0/Imagenes/AyudanteSanta.jpeg')  
    page.Send('//*[@id="crear-articulo-form"]/div[7]/div/div[1]/input','C:/Users/felep/OneDrive/Documentos/VSCode/Pylenium 2.0/Pylenium2.0/Imagenes/AyudanteSanta2.jpeg') 
    page.Click('//*[@id="modalPortal"]/div/div/div[3]/button')
    time.sleep(1)


def test_modificar_articulo(page:Sele):
    page.login_administrador()  
    #click en remates
    page.Click('//*[@id="pageContainer"]/main/section/div/button[1]')
    #Click en ver Ficha
...
def test_elimiar_articulo(page:Sele):
    page.login_administrador()  
    #click en remates
    page.Click('//*[@id="pageContainer"]/main/section/div/button[1]')
    #Click en ver Ficha
...
def crear_articulo2(page:Sele):
    ...
    page.Send('//*[@id="crear-articulo-form"]/div[6]/div/div[1]/input','C:/Users/felep/OneDrive/Documentos/VSCode/Pylenium 2.0/Pylenium2.0/Imagenes/Sillon.jpeg')  
    page.Send('//*[@id="crear-articulo-form"]/div[7]/div/div[1]/input','C:/Users/felep/OneDrive/Documentos/VSCode/Pylenium 2.0/Pylenium2.0/Imagenes/Sillon2.jpeg') 
    page.Click('//*[@id="modalPortal"]/div/div/div[3]/button')
    time.sleep(2)
